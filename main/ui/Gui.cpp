...
void Gui::Initialize(const char* title, int width, int height)
{
    ...
    // Chinese font
    float fontSize = 18.0f * main_scale;
...
bool Gui::BeginFrame(bool* frameReady)
{
    ...
    if (g_ResizeWidth != 0 && g_ResizeHeight != 0)
    {
        ...
        io.DisplaySize = ImVec2((float)g_ResizeWidth, (float)g_ResizeHeight);
